    ...
    <div class="stage">
        <div class="stage__header">
            ...
            <div class="stage__filters">
                <div :class="['icon', { active: sorting === 'down' }]" @click="changeSorting('down')">
                ...
                <div :class="['icon', { active: sorting === 'up' }]" @click="changeSorting('up')">
        ...
        <div class="stage__card-list" v-if="props.stage.cards?.length > 0">
            <card-item 
        ...
        <div v-else class="stage__empty-list" >Список пуст</div>
        <div class="stage__add-card">Добавить</div>
    </div>
</template>
...
type SortingType = 'default' | 'up' | 'down';
...
const sorting = ref('default' as SortingType)

const getSortedCards = computed((): CardInterface[] => {
    const cards = [...props.stage.cards]
